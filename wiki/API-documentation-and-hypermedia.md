...
<p>
	You have two options:
		<ol>
			...
			<li>Using an hypermedia format. Lots of examples provided in Extra material for Exercise 3. You can get full points. In this case you need to clearly include in the documentation a profile with link relations and semantic descriptors.</li>
		</ol>
...
<details>
<summary>
:heavy_check_mark:&nbsp;&nbsp;&nbsp;&nbsp; <strong>Chapter evaluation (max 16 points)</strong>
</summary>
